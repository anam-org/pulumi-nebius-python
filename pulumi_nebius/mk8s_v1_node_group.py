...
class Mk8sV1NodeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] fixed_node_count: Number of nodes in the group. Can be changed manually at any time. *Cannot be set alongside autoscaling.*
...
class Mk8sV1NodeGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template: Optional[pulumi.Input[Union['Mk8sV1NodeGroupTemplateArgs', 'Mk8sV1NodeGroupTemplateArgsDict']]] = None,
            updated_at: Optional[pulumi.Input[str]] = None,
            version: Optional[pulumi.Input[str]] = None) -> 'Mk8sV1NodeGroup':
        """
