...
class Mk8sV1NodeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] fixed_node_count: Number of nodes in the group. Can be changed manually at any time. *Cannot be set alongside autoscaling.*
        ...
        :param pulumi.Input[_builtins.str] version: Version is desired Kubernetes version of the cluster. For now only acceptable format is `<major>.<minor>` like "1.31".
    ...
    def version(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Version is desired Kubernetes version of the cluster. For now only acceptable format is `<major>.<minor>` like "1.31".
        Option for patch version update will be added later. By default the cluster control plane <major>.<minor> version will
        be used.
        """
