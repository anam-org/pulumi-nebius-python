...
class Mk8sV1NodeGroupArgs:
    def __init__(__self__, *,
                 ...
                 fixed_node_count: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input['Mk8sV1NodeGroupTemplateArgs'] template: Parameters for Kubernetes Node object and Nebius Compute Instance If not written opposite a NodeTemplate field update
               will cause NodeGroup roll-out according NodeGroupDeploymentStrategy.
        :param pulumi.Input['Mk8sV1NodeGroupAutoscalingArgs'] autoscaling: Enables [Kubernetes Cluster Autoscaler](https://github.com/kubernetes/autoscaler/tree/master/cluster-autoscaler) for
               that NodeGroup, and defines autoscaling parameters. *Cannot be set alongside fixed_node_count.*
        :param pulumi.Input[builtins.float] fixed_node_count: Number of nodes in the group. Can be changed manually at any time. *Cannot be set alongside autoscaling.*
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels associated with the resource.
        :param pulumi.Input['Mk8sV1NodeGroupMetadataArgs'] metadata: ### Inner value description Common resource metadata. The parent_id is an ID of Cluster
        :param pulumi.Input[builtins.str] name: Human readable name for the resource.
        :param pulumi.Input['Mk8sV1NodeGroupStrategyArgs'] strategy: Defines deployment - roll-out, or nodes re-creation during configuration change. Allows to setup compromise in roll-out
               speed, extra resources consumption and workloads disruption.
        :param pulumi.Input[builtins.str] version: Version is desired Kubernetes version of the cluster. For now only acceptable format is `<major>.<minor>` like "1.30".
               Option for patch version update will be added later. By default the cluster control plane <major>.<minor> version will
               be used.
        """
    ...
    def template(self) -> pulumi.Input['Mk8sV1NodeGroupTemplateArgs']:
        """
        Parameters for Kubernetes Node object and Nebius Compute Instance If not written opposite a NodeTemplate field update
        will cause NodeGroup roll-out according NodeGroupDeploymentStrategy.
        """
    ...
    def autoscaling(self) -> Optional[pulumi.Input['Mk8sV1NodeGroupAutoscalingArgs']]:
        """
        Enables [Kubernetes Cluster Autoscaler](https://github.com/kubernetes/autoscaler/tree/master/cluster-autoscaler) for
        that NodeGroup, and defines autoscaling parameters. *Cannot be set alongside fixed_node_count.*
        """
    ...
    def fixed_node_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Number of nodes in the group. Can be changed manually at any time. *Cannot be set alongside autoscaling.*
        """
        return pulumi.get(self, "fixed_node_count")

    @fixed_node_count.setter
    def fixed_node_count(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def strategy(self) -> Optional[pulumi.Input['Mk8sV1NodeGroupStrategyArgs']]:
        """
        Defines deployment - roll-out, or nodes re-creation during configuration change. Allows to setup compromise in roll-out
        speed, extra resources consumption and workloads disruption.
        """
...
class Mk8sV1NodeGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['Mk8sV1NodeGroupAutoscalingArgs', 'Mk8sV1NodeGroupAutoscalingArgsDict']] autoscaling: Enables [Kubernetes Cluster Autoscaler](https://github.com/kubernetes/autoscaler/tree/master/cluster-autoscaler) for
               that NodeGroup, and defines autoscaling parameters. *Cannot be set alongside fixed_node_count.*
        :param pulumi.Input[builtins.float] fixed_node_count: Number of nodes in the group. Can be changed manually at any time. *Cannot be set alongside autoscaling.*
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels associated with the resource.
        :param pulumi.Input[Union['Mk8sV1NodeGroupMetadataArgs', 'Mk8sV1NodeGroupMetadataArgsDict']] metadata: ### Inner value description Common resource metadata. The parent_id is an ID of Cluster
        :param pulumi.Input[builtins.str] name: Human readable name for the resource.
        :param pulumi.Input[builtins.str] parent_id: Identifier of the parent resource to which the resource belongs.
        :param pulumi.Input[Union['Mk8sV1NodeGroupStrategyArgs', 'Mk8sV1NodeGroupStrategyArgsDict']] strategy: Defines deployment - roll-out, or nodes re-creation during configuration change. Allows to setup compromise in roll-out
               speed, extra resources consumption and workloads disruption.
        :param pulumi.Input[Union['Mk8sV1NodeGroupTemplateArgs', 'Mk8sV1NodeGroupTemplateArgsDict']] template: Parameters for Kubernetes Node object and Nebius Compute Instance If not written opposite a NodeTemplate field update
               will cause NodeGroup roll-out according NodeGroupDeploymentStrategy.
        :param pulumi.Input[builtins.str] version: Version is desired Kubernetes version of the cluster. For now only acceptable format is `<major>.<minor>` like "1.30".
               Option for patch version update will be added later. By default the cluster control plane <major>.<minor> version will
               be used.
    ...
    def get(resource_name: str,
            ...
            template: Optional[pulumi.Input[Union['Mk8sV1NodeGroupTemplateArgs', 'Mk8sV1NodeGroupTemplateArgsDict']]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'Mk8sV1NodeGroup':
        """
    ...
    @property
    @pulumi.getter(name="fixedNodeCount")
    def fixed_node_count(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Number of nodes in the group. Can be changed manually at any time. *Cannot be set alongside autoscaling.*
        """
        return pulumi.get(self, "fixed_node_count")
