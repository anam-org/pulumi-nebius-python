...
class StorageV1BucketArgs:
    def __init__(__self__, *,
                 ...
                 override_storage_class: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] default_storage_class: Storage class to use by default for uploads to the bucket. It may be overridden by `x-amz-storage-class` header. If not
               set - STANDARD is used as a default storage class. ### Supported values Possible values: - `STORAGE_CLASS_UNSPECIFIED` -
               `STANDARD` - `ENHANCED_THROUGHPUT`
        ...
        :param pulumi.Input[_builtins.float] max_size_bytes: Maximum bucket size. Zero means unlimited. Actual limit can be lower if customer doesn't have enough quota. Real bucket
        ...
        :param pulumi.Input[_builtins.str] override_storage_class: Storage class to override any other storage class of uploading objects. It overrides the storage class regardless of how
               the original storage class was specified - either the default storage class or the one provided via the
               `x-amz-storage-class` header. ### Supported values Possible values: - `STORAGE_CLASS_UNSPECIFIED` - `STANDARD` -
               `ENHANCED_THROUGHPUT`
        :param pulumi.Input[_builtins.str] versioning_policy: Supports transitions: * disabled > enabled * disabled > suspended * enabled <> suspended ### Supported values Possible
        ...
        if override_storage_class is not None:
    ...
    def default_storage_class(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Storage class to use by default for uploads to the bucket. It may be overridden by `x-amz-storage-class` header. If not
        set - STANDARD is used as a default storage class. ### Supported values Possible values: - `STORAGE_CLASS_UNSPECIFIED` -
        `STANDARD` - `ENHANCED_THROUGHPUT`
        """
    ...
    def override_storage_class(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Storage class to override any other storage class of uploading objects. It overrides the storage class regardless of how
        the original storage class was specified - either the default storage class or the one provided via the
        `x-amz-storage-class` header. ### Supported values Possible values: - `STORAGE_CLASS_UNSPECIFIED` - `STANDARD` -
        `ENHANCED_THROUGHPUT`
        """
    ...
    def override_storage_class(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "override_storage_class", value)
...
class StorageV1Bucket(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["override_storage_class"] = override_storage_class
    ...
    @_builtins.property
    @pulumi.getter(name="overrideStorageClass")
    def override_storage_class(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Storage class to override any other storage class of uploading objects. It overrides the storage class regardless of how
        the original storage class was specified - either the default storage class or the one provided via the
        `x-amz-storage-class` header. ### Supported values Possible values: - `STORAGE_CLASS_UNSPECIFIED` - `STANDARD` -
