...
class StorageV1BucketArgs:
    def __init__(__self__, *,
                 ...
                 versioning_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.float] max_size_bytes: Maximum bucket size. Zero means unlimited. Actual limit can be lower if customer doesn't have enough quota. Real bucket
        ...
        :param pulumi.Input[builtins.str] versioning_policy: Supports transitions: * disabled > enabled * disabled > suspended * enabled <> suspended ### Supported values Possible
    ...
    def versioning_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def versioning_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StorageV1Bucket(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            versioning_policy: Optional[pulumi.Input[builtins.str]] = None) -> 'StorageV1Bucket':
        """
    ...
    @property
    @pulumi.getter(name="versioningPolicy")
    def versioning_policy(self) -> pulumi.Output[builtins.str]:
        """
        Supports transitions: * disabled > enabled * disabled > suspended * enabled <> suspended ### Supported values Possible
        values: - `VERSIONING_POLICY_UNSPECIFIED` - `DISABLED` - `ENABLED` - `SUSPENDED`
        """
