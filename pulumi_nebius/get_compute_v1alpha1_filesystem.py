...
__all__ = [
    'GetComputeV1alpha1FilesystemResult',
    'AwaitableGetComputeV1alpha1FilesystemResult',
    'get_compute_v1alpha1_filesystem',
    'get_compute_v1alpha1_filesystem_output',
]

@pulumi.output_type
class GetComputeV1alpha1FilesystemResult:
    """
    A collection of values returned by getComputeV1alpha1Filesystem.
    """
    def __init__(__self__, block_size_bytes=None, created_at=None, id=None, labels=None, metadata=None, name=None, parent_id=None, resource_version=None, size_bytes=None, size_gibibytes=None, size_kibibytes=None, size_mebibytes=None, status=None, type=None, updated_at=None):
    ...
    @property
    @pulumi.getter
    def metadata(self) -> 'outputs.GetComputeV1alpha1FilesystemMetadataResult':
    ...
    @property
    @pulumi.getter
    def status(self) -> 'outputs.GetComputeV1alpha1FilesystemStatusResult':
...
class AwaitableGetComputeV1alpha1FilesystemResult(GetComputeV1alpha1FilesystemResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetComputeV1alpha1FilesystemResult(
...
def get_compute_v1alpha1_filesystem(id: Optional[str] = None,
                                    name: Optional[str] = None,
                                    parent_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeV1alpha1FilesystemResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('nebius:index/getComputeV1alpha1Filesystem:getComputeV1alpha1Filesystem', __args__, opts=opts, typ=GetComputeV1alpha1FilesystemResult, package_ref=_utilities.get_package()).value

    return AwaitableGetComputeV1alpha1FilesystemResult(
...
def get_compute_v1alpha1_filesystem_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                           name: Optional[pulumi.Input[Optional[str]]] = None,
                                           parent_id: Optional[pulumi.Input[Optional[str]]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetComputeV1alpha1FilesystemResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('nebius:index/getComputeV1alpha1Filesystem:getComputeV1alpha1Filesystem', __args__, opts=opts, typ=GetComputeV1alpha1FilesystemResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetComputeV1alpha1FilesystemResult(
