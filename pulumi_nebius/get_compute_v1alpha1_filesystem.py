...
def get_compute_v1alpha1_filesystem(id: Optional[builtins.str] = None,
...
def get_compute_v1alpha1_filesystem_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
