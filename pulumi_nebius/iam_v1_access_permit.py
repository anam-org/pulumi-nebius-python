...
class IamV1AccessPermitArgs:
    def __init__(__self__, *,
                 ...
                 metadata: Optional[pulumi.Input['IamV1AccessPermitMetadataArgs']] = None,
        ...
        :param pulumi.Input['IamV1AccessPermitMetadataArgs'] metadata: ### Inner value description Common resource metadata.
        :param pulumi.Input[builtins.str] name: Human readable name for the resource.
        :param pulumi.Input[builtins.str] resource_id: Resource for granting access permit.
        :param pulumi.Input[builtins.str] role: Role for granting access permit.
        """
    ...
    @property
    @pulumi.getter
    def metadata(self) -> Optional[pulumi.Input['IamV1AccessPermitMetadataArgs']]:
        """
    ...
    @metadata.setter
    def metadata(self, value: Optional[pulumi.Input['IamV1AccessPermitMetadataArgs']]):
...
class _IamV1AccessPermitState:
    def __init__(__self__, *,
                 ...
                 role: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input['IamV1AccessPermitStatusArgs']] = None,
    ...
    @property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input['IamV1AccessPermitStatusArgs']]:
        return pulumi.get(self, "status")

    @status.setter
    def status(self, value: Optional[pulumi.Input['IamV1AccessPermitStatusArgs']]):
...
class IamV1AccessPermit(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 metadata: Optional[pulumi.Input[Union['IamV1AccessPermitMetadataArgs', 'IamV1AccessPermitMetadataArgsDict']]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 role: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels associated with the resource.
        :param pulumi.Input[Union['IamV1AccessPermitMetadataArgs', 'IamV1AccessPermitMetadataArgsDict']] metadata: ### Inner value description Common resource metadata.
        :param pulumi.Input[builtins.str] name: Human readable name for the resource.
        :param pulumi.Input[builtins.str] parent_id: Identifier of the parent resource to which the resource belongs.
        :param pulumi.Input[builtins.str] resource_id: Resource for granting access permit.
        :param pulumi.Input[builtins.str] role: Role for granting access permit.
    ...
    def get(resource_name: str,
            ...
            resource_version: Optional[pulumi.Input[builtins.float]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[Union['IamV1AccessPermitStatusArgs', 'IamV1AccessPermitStatusArgsDict']]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'IamV1AccessPermit':
        """
