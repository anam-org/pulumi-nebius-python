...
class IamV1FederatedCredentialsArgs:
    def __init__(__self__, *,
                 federated_subject_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] subject_id: IAM subject, in which federated subject will be impersonated to. E.g. for workload identities it will be IAM service
               account.
    ...
    def federated_subject_id(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "federated_subject_id")

    @federated_subject_id.setter
    def federated_subject_id(self, value: pulumi.Input[_builtins.str]):
...
class IamV1FederatedCredentials(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="federatedSubjectId")
    def federated_subject_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "federated_subject_id")
