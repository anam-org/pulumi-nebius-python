...
class IamV1FederatedCredentialsArgs:
    def __init__(__self__, *,
                 federated_subject_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] subject_id: IAM subject, in which federated subject will be impersonated to. E.g. for workload identities it will be IAM service
               account.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels associated with the resource.
        :param pulumi.Input['IamV1FederatedCredentialsMetadataArgs'] metadata: ### Inner value description Common resource metadata.
    ...
    def federated_subject_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "federated_subject_id")

    @federated_subject_id.setter
    def federated_subject_id(self, value: pulumi.Input[builtins.str]):
    ...
    def subject_id(self) -> pulumi.Input[builtins.str]:
        """
        IAM subject, in which federated subject will be impersonated to. E.g. for workload identities it will be IAM service
        account.
        """
...
class _IamV1FederatedCredentialsState:
    def __init__(__self__, *,
                 ...
                 federated_subject_id: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 metadata: Optional[pulumi.Input['IamV1FederatedCredentialsMetadataArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 oidc_provider: Optional[pulumi.Input['IamV1FederatedCredentialsOidcProviderArgs']] = None,
    ...
    @property
    @pulumi.getter(name="federatedSubjectId")
    def federated_subject_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "federated_subject_id")

    @federated_subject_id.setter
    def federated_subject_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "federated_subject_id", value)
...
class IamV1FederatedCredentials(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels associated with the resource.
        :param pulumi.Input[Union['IamV1FederatedCredentialsMetadataArgs', 'IamV1FederatedCredentialsMetadataArgsDict']] metadata: ### Inner value description Common resource metadata.
        :param pulumi.Input[builtins.str] name: Human readable name for the resource.
        :param pulumi.Input[builtins.str] parent_id: Identifier of the parent resource to which the resource belongs.
        :param pulumi.Input[builtins.str] subject_id: IAM subject, in which federated subject will be impersonated to. E.g. for workload identities it will be IAM service
               account.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if federated_subject_id is None and not opts.urn:
                raise TypeError("Missing required property 'federated_subject_id'")
    ...
    def get(resource_name: str,
            ...
            subject_id: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'IamV1FederatedCredentials':
        """
    ...
    @property
    @pulumi.getter(name="federatedSubjectId")
    def federated_subject_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "federated_subject_id")
