...
class GetComputeV1ImageResult:
    ...
    """
    def __init__(__self__, cpu_architecture=None, created_at=None, description=None, id=None, image_family=None, labels=None, metadata=None, name=None, parent_id=None, resource_version=None, status=None, updated_at=None, version=None):
...
def get_compute_v1_image(id: Optional[builtins.str] = None,
...
def get_compute_v1_image_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
