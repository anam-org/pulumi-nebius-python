...
class GetComputeV1InstanceResult:
    ...
    """
    def __init__(__self__, boot_disk=None, cloud_init_user_data=None, created_at=None, filesystems=None, gpu_cluster=None, hostname=None, id=None, labels=None, metadata=None, name=None, network_interfaces=None, parent_id=None, preemptible=None, recovery_policy=None, resource_version=None, resources=None, secondary_disks=None, service_account_id=None, status=None, stopped=None, updated_at=None):
