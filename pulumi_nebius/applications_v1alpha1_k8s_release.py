...
class ApplicationsV1alpha1K8sReleaseArgs:
    ...
    def product_slug(self) -> pulumi.Input[str]:
        return pulumi.get(self, "product_slug")

    @product_slug.setter
    def product_slug(self, value: pulumi.Input[str]):
...
class _ApplicationsV1alpha1K8sReleaseState:
    def __init__(__self__, *,
                 ...
                 product_slug: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter(name="productSlug")
    def product_slug(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "product_slug")

    @product_slug.setter
    def product_slug(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "product_slug", value)
...
class ApplicationsV1alpha1K8sRelease(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[str]] = None,
            values: Optional[pulumi.Input[str]] = None) -> 'ApplicationsV1alpha1K8sRelease':
        """
    ...
    @property
    @pulumi.getter(name="productSlug")
    def product_slug(self) -> pulumi.Output[str]:
        return pulumi.get(self, "product_slug")
    ...
    @property
    @pulumi.getter
    def set(self) -> pulumi.Output[Optional[Mapping[str, str]]]:
        return pulumi.get(self, "set")
