...
class MspSparkV1alpha1SessionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the session.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: S3 URIs of files to be placed in executor working directory
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_uris: S3 URIs of Jars to be placed in classpaths of driver and executors for java applications
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] packages: List of maven coordinates of jars to include on the driver and executor classpaths
        :param pulumi.Input['MspSparkV1alpha1SessionPythonArgs'] python: Python runtime-specific session config
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] spark_conf: Map of spark configuration parameters
        """
...
class MspSparkV1alpha1Session(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'MspSparkV1alpha1Session':
        """
    ...
    @property
    @pulumi.getter(name="fileUris")
    def file_uris(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        S3 URIs of files to be placed in executor working directory
        """
        return pulumi.get(self, "file_uris")
    ...
    @property
    @pulumi.getter(name="jarUris")
    def jar_uris(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        S3 URIs of Jars to be placed in classpaths of driver and executors for java applications
        """
        return pulumi.get(self, "jar_uris")
