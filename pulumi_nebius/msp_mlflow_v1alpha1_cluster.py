...
class MspMlflowV1alpha1ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] size: Size defines how much resources will be allocated to mlflow See supported sizes in the documentation. Default size is
               the smallest available in the region.
    ...
    def size(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Size defines how much resources will be allocated to mlflow See supported sizes in the documentation. Default size is
        the smallest available in the region.
        """
