...
class MspMlflowV1alpha1ClusterArgs:
    def __init__(__self__, *,
                 ...
                 storage_bucket_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MspMlflowV1alpha1Cluster resource.
        :param pulumi.Input[builtins.str] admin_password: MLflow admin password.
        :param pulumi.Input[builtins.str] admin_username: MLflow admin username.
        :param pulumi.Input[builtins.str] network_id: ID of the vpc network.
        :param pulumi.Input[builtins.str] parent_id: Identifier of the parent resource to which the resource belongs.
        :param pulumi.Input[builtins.str] service_account_id: Id of the service account that will be used to access S3 bucket (and create one if not provided).
        ...
        :param pulumi.Input[builtins.str] storage_bucket_name: Name of the Nebius S3 bucket for MLflow artifacts. If not provided, will be created under the same parent.
        """
    ...
    def storage_bucket_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_bucket_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MspMlflowV1alpha1Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_bucket_name: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'MspMlflowV1alpha1Cluster':
        """
    ...
    @property
    @pulumi.getter(name="publicAccess")
    def public_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Either make cluster public accessible or accessible only via private VPC.
        """
        return pulumi.get(self, "public_access")
    ...
    @property
    @pulumi.getter(name="storageBucketName")
    def storage_bucket_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the Nebius S3 bucket for MLflow artifacts. If not provided, will be created under the same parent.
        """
        return pulumi.get(self, "storage_bucket_name")
