...
class IamV1GroupMembershipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] member_id: Member of the group. Can be tenant user account id or service account id.
...
class IamV1GroupMembership(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'IamV1GroupMembership':
        """
