...
class GetComputeV1alpha1InstanceResult:
    ...
    def recovery_policy(self) -> builtins.str:
...
def get_compute_v1alpha1_instance(id: Optional[builtins.str] = None,
...
def get_compute_v1alpha1_instance_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
