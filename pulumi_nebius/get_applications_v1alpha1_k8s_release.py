...
class GetApplicationsV1alpha1K8sReleaseResult:
    ...
    @property
    @pulumi.getter
    def set(self) -> Mapping[str, builtins.str]:
...
def get_applications_v1alpha1_k8s_release(id: Optional[builtins.str] = None,
...
def get_applications_v1alpha1_k8s_release_output(id: Optional[pulumi.Input[builtins.str]] = None,
