...
class MspSparkV1alpha1ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_account_id: ID of the user service account for accessing S3 buckets in the user project
...
class MspSparkV1alpha1Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'MspSparkV1alpha1Cluster':
        """
