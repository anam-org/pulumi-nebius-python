...
class GetComputeV1DiskResult:
    ...
    def placement_policy(self) -> 'outputs.GetComputeV1DiskPlacementPolicyResult':
...
def get_compute_v1_disk(id: Optional[str] = None,
...
def get_compute_v1_disk_output(id: Optional[pulumi.Input[Optional[str]]] = None,
