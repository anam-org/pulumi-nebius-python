...
class ComputeV1DiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: ### Supported values the list of available types will be clarified later, it is not final version Possible values: -
...
@pulumi.type_token("nebius:index/computeV1Disk:ComputeV1Disk")
class ComputeV1Disk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'ComputeV1Disk':
        """
