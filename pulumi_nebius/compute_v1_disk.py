...
class ComputeV1DiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The type of disk defines the performance and reliability characteristics of the block device. For details, see
               https://docs.nebius.com/compute/storage/types#disks-types ### Supported values the list of available types will be
               clarified later, it is not final version Possible values: - `UNSPECIFIED` - `NETWORK_SSD` - `NETWORK_HDD` -
               `NETWORK_SSD_NON_REPLICATED` - `NETWORK_SSD_IO_M3`
        :param pulumi.Input[_builtins.float] block_size_bytes: Block size in bytes. The block size must be a power of two between 4096 bytes (4 KiB) and 131072 bytes (128 KiB). The
               default value is 4096 bytes (4 KiB).
        :param pulumi.Input['ComputeV1DiskDiskEncryptionArgs'] disk_encryption: Defines how data on the disk is encrypted. By default, no encryption is applied. This field applies for disks with
               NETWORK_SSD_NON_REPLICATED and NETWORK_SSD_IO_M3 types only.
    ...
    def type(self) -> pulumi.Input[_builtins.str]:
        """
        The type of disk defines the performance and reliability characteristics of the block device. For details, see
        https://docs.nebius.com/compute/storage/types#disks-types ### Supported values the list of available types will be
        clarified later, it is not final version Possible values: - `UNSPECIFIED` - `NETWORK_SSD` - `NETWORK_HDD` -
        `NETWORK_SSD_NON_REPLICATED` - `NETWORK_SSD_IO_M3`
        """
    ...
    def block_size_bytes(self) -> Optional[pulumi.Input[_builtins.float]]:
        """
        Block size in bytes. The block size must be a power of two between 4096 bytes (4 KiB) and 131072 bytes (128 KiB). The
        default value is 4096 bytes (4 KiB).
        """
    ...
    def disk_encryption(self) -> Optional[pulumi.Input['ComputeV1DiskDiskEncryptionArgs']]:
        """
        Defines how data on the disk is encrypted. By default, no encryption is applied. This field applies for disks with
        NETWORK_SSD_NON_REPLICATED and NETWORK_SSD_IO_M3 types only.
        """
...
class ComputeV1Disk(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.float] block_size_bytes: Block size in bytes. The block size must be a power of two between 4096 bytes (4 KiB) and 131072 bytes (128 KiB). The
               default value is 4096 bytes (4 KiB).
        :param pulumi.Input[Union['ComputeV1DiskDiskEncryptionArgs', 'ComputeV1DiskDiskEncryptionArgsDict']] disk_encryption: Defines how data on the disk is encrypted. By default, no encryption is applied. This field applies for disks with
               NETWORK_SSD_NON_REPLICATED and NETWORK_SSD_IO_M3 types only.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels associated with the resource.
    ...
    @_builtins.property
    @pulumi.getter(name="diskEncryption")
    def disk_encryption(self) -> pulumi.Output[Optional['outputs.ComputeV1DiskDiskEncryption']]:
        """
        Defines how data on the disk is encrypted. By default, no encryption is applied. This field applies for disks with
        NETWORK_SSD_NON_REPLICATED and NETWORK_SSD_IO_M3 types only.
        """
