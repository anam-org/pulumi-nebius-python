...
class Mk8sV1alpha1NodeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] fixed_node_count: *Cannot be set alongside autoscaling.*
...
@pulumi.type_token("nebius:index/mk8sV1alpha1NodeGroup:Mk8sV1alpha1NodeGroup")
class Mk8sV1alpha1NodeGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template: Optional[pulumi.Input[Union['Mk8sV1alpha1NodeGroupTemplateArgs', 'Mk8sV1alpha1NodeGroupTemplateArgsDict']]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'Mk8sV1alpha1NodeGroup':
        """
