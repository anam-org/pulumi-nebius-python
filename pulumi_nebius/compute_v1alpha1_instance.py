...
class ComputeV1alpha1InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] recovery_policy: ### Supported values Possible values: - `RECOVER` - `FAIL`
        """
...
class ComputeV1alpha1Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stopped: Optional[pulumi.Input[builtins.bool]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'ComputeV1alpha1Instance':
        """
    ...
    @property
    @pulumi.getter(name="cloudInitUserData")
    def cloud_init_user_data(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "cloud_init_user_data")
    ...
    @property
    @pulumi.getter(name="recoveryPolicy")
    def recovery_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ### Supported values Possible values: - `RECOVER` - `FAIL`
        """
        return pulumi.get(self, "recovery_policy")
