...
class ComputeV1alpha1DiskArgs:
    def __init__(__self__, *,
                 ...
                 source_image_family: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] type: ### Supported values Possible values: - `UNSPECIFIED` - `NETWORK_SSD` - the list of available types will be clarified
        ...
        :param pulumi.Input[str] source_image_family: *Cannot be set alongside source_image_id.*
    ...
    def source_image_family(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def source_image_family(self, value: Optional[pulumi.Input[str]]):
...
class ComputeV1alpha1Disk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'ComputeV1alpha1Disk':
        """
    ...
    @property
    @pulumi.getter(name="sourceImageFamily")
    def source_image_family(self) -> pulumi.Output[Optional[str]]:
        """
        *Cannot be set alongside source_image_id.*
        """
        return pulumi.get(self, "source_image_family")
