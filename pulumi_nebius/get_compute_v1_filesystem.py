...
__all__ = [
    'GetComputeV1FilesystemResult',
    'AwaitableGetComputeV1FilesystemResult',
    'get_compute_v1_filesystem',
    'get_compute_v1_filesystem_output',
]

@pulumi.output_type
class GetComputeV1FilesystemResult:
    """
    A collection of values returned by getComputeV1Filesystem.
    """
    ...
    @property
    @pulumi.getter
    def metadata(self) -> 'outputs.GetComputeV1FilesystemMetadataResult':
    ...
    @property
    @pulumi.getter
    def status(self) -> 'outputs.GetComputeV1FilesystemStatusResult':
...
class AwaitableGetComputeV1FilesystemResult(GetComputeV1FilesystemResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetComputeV1FilesystemResult(
...
def get_compute_v1_filesystem(id: Optional[str] = None,
                              name: Optional[str] = None,
                              parent_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeV1FilesystemResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('nebius:index/getComputeV1Filesystem:getComputeV1Filesystem', __args__, opts=opts, typ=GetComputeV1FilesystemResult, package_ref=_utilities.get_package()).value

    return AwaitableGetComputeV1FilesystemResult(
...
def get_compute_v1_filesystem_output(id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('nebius:index/getComputeV1Filesystem:getComputeV1Filesystem', __args__, opts=opts, typ=GetComputeV1FilesystemResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetComputeV1FilesystemResult(
