...
class VpcV1PoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] version: IP version for the Pool. ### Supported values Possible values: - `IP_VERSION_UNSPECIFIED` - Default, unspecified IP
               version. - `IPV4` - IPv4 address. - `IPV6` - IPv6 address.
        :param pulumi.Input[_builtins.str] visibility: ### Supported values Possible values: - `IP_VISIBILITY_UNSPECIFIED` - Default, unspecified IP visibility. - `PRIVATE` -
        ...
        :param pulumi.Input[_builtins.str] source_pool_id: ID of source pool. Current pool will be created with the same scope. Pool is a root-pool if this field is empty
        """
