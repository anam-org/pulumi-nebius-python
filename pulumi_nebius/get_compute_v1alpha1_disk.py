...
class GetComputeV1alpha1DiskResult:
    ...
    def source_image_family(self) -> builtins.str:
...
def get_compute_v1alpha1_disk(id: Optional[builtins.str] = None,
...
def get_compute_v1alpha1_disk_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
