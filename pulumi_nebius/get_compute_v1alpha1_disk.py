...
__all__ = [
    'GetComputeV1alpha1DiskResult',
    'AwaitableGetComputeV1alpha1DiskResult',
    'get_compute_v1alpha1_disk',
    'get_compute_v1alpha1_disk_output',
]

@pulumi.output_type
class GetComputeV1alpha1DiskResult:
    """
    A collection of values returned by getComputeV1alpha1Disk.
    """
    def __init__(__self__, block_size_bytes=None, created_at=None, id=None, labels=None, metadata=None, name=None, parent_id=None, resource_version=None, size_bytes=None, size_gibibytes=None, size_kibibytes=None, size_mebibytes=None, source_image_family=None, source_image_id=None, status=None, type=None, updated_at=None):
        ...
        if source_image_family and not isinstance(source_image_family, str):
            raise TypeError("Expected argument 'source_image_family' to be a str")
    ...
    @_builtins.property
    @pulumi.getter
    def metadata(self) -> 'outputs.GetComputeV1alpha1DiskMetadataResult':
    ...
    def source_image_family(self) -> _builtins.str:
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> 'outputs.GetComputeV1alpha1DiskStatusResult':
...
class AwaitableGetComputeV1alpha1DiskResult(GetComputeV1alpha1DiskResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetComputeV1alpha1DiskResult(
...
def get_compute_v1alpha1_disk(id: Optional[_builtins.str] = None,
                              name: Optional[_builtins.str] = None,
                              parent_id: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeV1alpha1DiskResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('nebius:index/getComputeV1alpha1Disk:getComputeV1alpha1Disk', __args__, opts=opts, typ=GetComputeV1alpha1DiskResult, package_ref=_utilities.get_package()).value

    return AwaitableGetComputeV1alpha1DiskResult(
...
def get_compute_v1alpha1_disk_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     parent_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetComputeV1alpha1DiskResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('nebius:index/getComputeV1alpha1Disk:getComputeV1alpha1Disk', __args__, opts=opts, typ=GetComputeV1alpha1DiskResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetComputeV1alpha1DiskResult(
