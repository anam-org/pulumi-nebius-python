...
class GetComputeV1alpha1DiskResult:
    ...
    """
    def __init__(__self__, block_size_bytes=None, created_at=None, id=None, labels=None, metadata=None, name=None, parent_id=None, placement_policy=None, resource_version=None, size_bytes=None, size_gibibytes=None, size_kibibytes=None, size_mebibytes=None, source_image_family=None, source_image_id=None, status=None, type=None, updated_at=None):
    ...
    def placement_policy(self) -> 'outputs.GetComputeV1alpha1DiskPlacementPolicyResult':
    ...
    def source_image_family(self) -> str:
...
def get_compute_v1alpha1_disk(id: Optional[str] = None,
...
def get_compute_v1alpha1_disk_output(id: Optional[pulumi.Input[Optional[str]]] = None,
